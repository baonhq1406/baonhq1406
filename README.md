...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00C9FF,50:92FE9D,100:00F2FE&height=180&section=header&text=TECH%20PROFILE&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=35"/>
...
<img src="https://skillicons.dev/icons?i=java,cpp,c,python,javascript,typescript,kotlin&theme=dark" />

<br/>

### 🌐 Frontend

<img src="https://skillicons.dev/icons?i=react,vite,html,css,bootstrap,tailwind&theme=dark" />

<br/>

### ⚙️ Backend

<img src="https://skillicons.dev/icons?i=nodejs,express,spring,flask,fastapi&theme=dark" />
...
<img src="https://skillicons.dev/icons?i=docker,kubernetes,linux,ubuntu,git,github,gitlab&theme=dark" />

<br/>

### 🛠️ Development Tools

<img src="https://skillicons.dev/icons?i=vscode,idea,androidstudio,postman,gradle,npm&theme=dark" />
...
|---|---|
| 💻 Languages | Java • C++ • C • Python • JavaScript • TypeScript • Kotlin |
| 🎨 Frontend | React • Vite • HTML • CSS • Tailwind • Bootstrap |
| ⚙️ Backend | Node.js • Express • Spring Boot • Flask • FastAPI |
| 🗄️ Database | PostgreSQL • MySQL • SQLite • Firebase |
| 📱 Mobile | Android • Kotlin • Jetpack Compose |
| ☁️ DevOps | Docker • Kubernetes • Linux • Ubuntu |
| 🔧 Tools | Git • GitHub • GitLab • VS Code • IntelliJ • Postman |
| 🤖 AI / ML | Python • REST APIs • AI APIs • Computer Vision |
...
![Python](https://img.shields.io/badge/Python-AI%20%2F%20Backend-3776AB?style=for-the-badge&logo=python&logoColor=white)
